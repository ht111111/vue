  ...
  <div class="app-container">
    ...
    > 
     <el-table-column label="ID" prop="id" sortable="custom" align="center" width="80" :class-name="getSortClass('id')">
      ...
      <el-table-column label="专栏内容" width="700px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="更新状态" width="100px"  align="center">
        <template slot-scope="{row}" >
          <el-tag  >
            {{ row.isend === 1 ? '连载中' : '已完结' }}
          </el-tag>
      ...
      <el-table-column label="Actions" align="center" width="330" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button type="warning" size="mini" @click="handleDirectory(row.id)">
            目录
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" fullscreen="true">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="课程介绍" >
          <el-input type="textarea" v-model="temp.try" />
        </el-form-item>
...
import { fetchList,  fetchPv, createColumn, updateColumn } from '@/api/column'
...
export default {
  ...
  methods: {
    ...
    handleDirectory(id){
      this.$router.push({ name: 'column_detail', query: { id: id } })
    },
